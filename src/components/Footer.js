...
class Footer extends Component {
    ...
    componentDidMount() {
      ...
      window.addEventListener('resize', this.toggleResizeEvent);
    };

    componentWillUnmount() {
      this.toggleResizeEvent();;
      window.removeEventListener('resize', this.toggleResizeEvent );
    }
  ...
  render() {
    ...
    return(
      ...
      <Grid container spacing={0} className="footer" style={styles.footer}>
        <Grid item xs={12} sm={4} style={styles.gridItem}>
          <Grid container >
            <CardContent style={styles.cardContent} >
              <ul className="footer-links social-links">
                <li>
                <SvgIcon style={styles.socialIcon}>
                  <svg viewBox="0 0 32 32" role="img" aria-label="Facebook" focusable="false" style={{height: '18px', width: '18px', display: 'block'}}>
                ...
                <li>
                <SvgIcon style={styles.socialIcon}>
                  <svg viewBox="0 0 32 32" role="img" aria-label="Twitter" focusable="false" style={{ height: '18px', width: '18px', display: 'block'}}>
                ...
                <li>
                <SvgIcon style={styles.socialIcon}>
                  <svg viewBox="0 0 24 24" role="img" aria-label="Instagram" focusable="false" style={{height: '18px', width: '18px', display: 'block'}}>
        ...
        <Grid item xs={12} sm={4} style={styles.gridItem}>
          <Grid container >
            ...
            <ul className="footer-list">
              <li>StrawberryJams</li>
              <li>123 Fake Street<br/>Your City, CA 98765</li>
            </ul>
            </CardContent>
          </Grid>
        </Grid>
